...
When images land in the project's `public/imagery/<category>/` folder, list them here as a key/value catalogue:
...
The kit is generated once per palette family, post-processed, and committed to the project's public folder:
